---
title: Ehdotetut segmentit (esiversio)
...
Customer Insightsin käyttäjänä olet todennäköisesti [luonut useita mittareita](measures.md), jotka auttavat tunnuslukujen (KPI:t) seuraamisessa. On tärkeää ymmärtää, miten tietyt määritteet vaikuttavat tähän KPI-lukuun, jotta voidaan luoda segmenttejä ja suorittaa erittäin kohdistettuja kampanjoita.   
