...
> [!NOTE]
> Jos organisaatiossasi on jo Dataverse käytössä vuokraajassaan, on tärkeää muistaa, että [Dataverse-ympäristön luontia hallitsee järjestelmänvalvoja](/power-platform/admin/control-environment-creation). Jos esimerkiksi määrität organisaatiotililläsi uutta Customer Insights -ympäristöä ja järjestelmänvalvoja on poistanut Dataverse-kokeiluympäristöjen luomisen käytöstä kaikille järjestelmänvalvojille, et voi luoda uutta kokeiluympäristöä.
> 
