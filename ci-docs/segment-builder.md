...
description: Asiakassegmenttejä luodaan ryhmittelemällä niitä erilaisten määritteiden perusteella käyttämällä segmentin muodostinta tai pikasegmenttejä.
ms.date: 03/25/2022
