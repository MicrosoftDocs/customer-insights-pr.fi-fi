...
1. Valitse **Tietojen päivitysaikataulu** -vaiheessa aikaväli, jonka mukaan mallia koulutetaan uudelleen uusimpien tietojen perusteella. Tämä asetus on tärkeä ennusteiden tarkkuuden päivityksessä käsiteltäessä uusia tietoja käyttäjäryhmän merkityksellisissä tiedoissa. Useimmat yritykset voivat uudelleenkouluttaa kerran kuukaudessa ja saada hyvän tarkkuuden ennusteille.
