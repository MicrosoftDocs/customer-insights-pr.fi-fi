...
1. Organisaatiossa on [Common Data Servicessa määritetty](https://docs.microsoft.com/ai-builder/build-model#prerequisites) esiintymä, joka on samassa organisaatiossa kuin Customer Insights.
...
5. Päivitä malli AI Builderissa. [Lisätietoja mallien hallinnasta AI builderissa](https://docs.microsoft.com/ai-builder/manage-model#retrain-and-republish-existing-models).
